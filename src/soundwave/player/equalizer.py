...
BANDS_31 = [
    ("20 Hz",    20),   ("25 Hz",    25),   ("31 Hz",  31.5),
    ("40 Hz",    40),   ("50 Hz",    50),   ("63 Hz",    63),
    ("80 Hz",    80),   ("100 Hz",  100),   ("125 Hz",  125),
    ("160 Hz",  160),   ("200 Hz",  200),   ("250 Hz",  250),
    ("315 Hz",  315),   ("400 Hz",  400),   ("500 Hz",  500),
    ("630 Hz",  630),   ("800 Hz",  800),   ("1 kHz",  1000),
    ("1.25k",  1250),   ("1.6k",   1600),   ("2 kHz",  2000),
    ("2.5k",   2500),   ("3.15k",  3150),   ("4 kHz",  4000),
    ("5 kHz",  5000),   ("6.3k",   6300),   ("8 kHz",  8000),
    ("10 kHz", 10000),  ("12.5k", 12500),   ("16 kHz", 16000),
    ("20 kHz", 20000),
]

BANDS_15 = [
    ("25 Hz",    25),   ("40 Hz",    40),   ("63 Hz",    63),
    ("100 Hz",  100),   ("160 Hz",  160),   ("250 Hz",  250),
    ("400 Hz",  400),   ("630 Hz",  630),   ("1 kHz",  1000),
    ("1.6k",   1600),   ("2.5k",   2500),   ("4 kHz",  4000),
    ("6.3k",   6300),   ("10 kHz", 10000),  ("16 kHz", 16000),
]
